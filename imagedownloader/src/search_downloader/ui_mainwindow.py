...
"}*/")
        ...
        self.radioButton_api = QtWidgets.QRadioButton(self.widget_driver)
        self.radioButton_api.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.radioButton_api.setFont(font)
        self.radioButton_api.setObjectName("radioButton_api")
        self.horizontalLayout_6.addWidget(self.radioButton_api)
        ...
        self.checkBox_from_file.clicked['bool'].connect(self.lineEdit_keywords.setDisabled) # type: ignore
        self.checkBox_from_file.clicked['bool'].connect(self.pushButton_load_file.setEnabled) # type: ignore
        self.checkBox_from_file.clicked['bool'].connect(self.lineEdit_path2file.setEnabled) # type: ignore
        self.checkBox_proxy.clicked['bool'].connect(self.widget_5.setEnabled) # type: ignore
        self.checkBox_proxy.clicked['bool'].connect(self.lineEdit_proxy.setFocus) # type: ignore
        self.radioButton_google.toggled['bool'].connect(self.checkBox_safe_mode.setEnabled) # type: ignore
        self.radioButton_bing.toggled['bool'].connect(self.checkBox_safe_mode.setChecked) # type: ignore
        self.radioButton_baidu.toggled['bool'].connect(self.checkBox_safe_mode.setChecked) # type: ignore
        self.radioButton_google.toggled['bool'].connect(self.checkBox_safe_mode.setChecked) # type: ignore
        self.checkBox_from_file.clicked['bool'].connect(self.pushButton_load_file.click) # type: ignore
        self.radioButton_google.toggled['bool'].connect(self.radioButton_api.setDisabled) # type: ignore
        self.radioButton_baidu.toggled['bool'].connect(self.radioButton_api.setChecked) # type: ignore
        self.radioButton_baidu.toggled['bool'].connect(self.radioButton_api.setEnabled) # type: ignore
        self.radioButton_google.toggled['bool'].connect(self.radioButton_chrome_headless.setChecked) # type: ignore
        self.radioButton_bing.toggled['bool'].connect(self.radioButton_api.setChecked) # type: ignore
        self.radioButton_bing.toggled['bool'].connect(self.radioButton_api.setEnabled) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_api.setText(_translate("MainWindow", "API"))
        ...
        self.lineEdit_output.setText(_translate("MainWindow", "./output/search"))
